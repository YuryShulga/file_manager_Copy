...
Disk::Disk(std::string current_path) :
	m_current_path{ current_path }
{
}

void Disk::view_content()
{
...
void Disk::create_subfolder(std::string& name)
{
...
void Disk::create_file(std::string& name)
{
	File d(name);
	d.create_file();
}
